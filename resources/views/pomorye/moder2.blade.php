...
<body>
	...
	<div class="row">
		<div class="col-md-12 mx-auto">
			<div class="row  p-4">
				<div class="col-md-12">
					<h3><a href="">Новые обращения </a>/ <a href="">Обработанные</a></h3>
				</div>
				...
				<div class="col-md-6">
					...
					<form class="needs-validation" novalidate="">
						<div class="row mt-4">
							...
							<button type="button"  type="submit" class="btn btn-success mx-auto">В работу</button>
						</div>
					</form>
				</div>
				...
				<div class="col-md-6">
					...
					<form class="needs-validation" novalidate="">
						<div class="row mt-4">
							...
							<button type="button"  type="submit" class="btn btn btn-danger mx-auto">Отклонить </button>
						</div>
					</form>
				</div>
			</div>
